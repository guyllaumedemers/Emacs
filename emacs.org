...
#+begin_src emacs-lisp
  ...
  ;; make function returning parse %PATH% thta return mingw using regex and flip \ to /
  (use-package company-c-headers
    :config (add-to-list 'company-backends 'company-c-headers)
    (add-to-list 'company-c-headers-path-system "C:/ProgramData/chocolatey/lib/mingw/tools/install/mingw64/lib/gcc/x86_64-w64-mingw32/12.2.0/include/c++"))
