...
#+begin_src emacs-lisp
  ...
  ;;     ;; install chocolatey on window using cmd prompt
  ;;     (interactive)
...
#+begin_src emacs-lisp
  ...
  ;;   (defun install-git ()
  ;;     (interactive)
  ;;     (shell-command "choco install git"))
  ;;   (install-git))
...
#+begin_src emacs-lisp
  ...
  ;;   (defun install-gh ()
  ;;     (interactive)
  ;;     (shell-command "choco install gh"))
  ;;   (install-gh))
...
#+begin_src emacs-lisp
  ...
  ;;   (defun install-mingw ()
  ;;     (interactive)
  ;;     (shell-command "choco install mingw"))
  ;;   (install-mingw)) 
...
#+begin_src emacs-lisp
  ...
  ;;   (defun install-cmake ()
  ;;     (interactive)
  ;;     (shell-command "choco install cmake"))
  ;;   (install-cmake))
...
#+begin_src emacs-lisp
  ...
  ;;   (defun install-llvm ()
  ;;     (interactive)
  ;;     (shell-command "choco install llvm"))
  ;;   (install-llvm))
...
#+begin_src emacs-lisp
  ...
  (use-package dap-mode
    :init
    (when (require 'dap-gdb-lldb nil 'noerror)
      (dap-gdb-lldb-setup))
    :hook
    (lsp-deferred . dap-mode)
    (dap-mode . efs/dap-mode)
    :config
