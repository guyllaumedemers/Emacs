...
#+begin_src emacs-lisp
  ...
  (defun cmake-init-root-toolchain ()
    (interactive)
    (get_https_request "https://github.com/guyllaumedemers/emacs-get-request/blob/master/toolchain.cmake" "toolchain.cmake"))
...
#+begin_src emacs-lisp
  ...
  (defun init-clangd ()
    (interactive)
    (get_https_request "https://github.com/guyllaumedemers/emacs-get-request/blob/master/.clangd" ".clangd"))
